...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "landing.faq.a2": "Every stock movement gets a verifiable proof that the record is authentic and hasn't been altered. If anyone ever disputes a number, you have a tamper-evident answer.",
    "landing.faq.q3": "Can my whole team work on the same warehouse at once?",
    "landing.faq.a3": "Yes. Multiple users can operate on one warehouse concurrently. Stock updates are atomic and synchronize in real time to everyone connected.",
    "landing.faq.q4": "What roles are available?",
    "landing.faq.a4": "There are five roles: Owner, Manager, Staff, Auditor, and Viewer. Each controls exactly what a person can see and do, from full control down to read-only.",
    "landing.faq.q5": "What network is used for blockchain verification?",
    "landing.faq.a5": "Chainventory currently runs on Base Sepolia, a test network. This keeps things free and safe while the product matures.",
    "landing.faq.q6": "Is my inventory data stored on the blockchain?",
    "landing.faq.a6": "No. Your operational data lives in a secure database. Only proof records (not your full inventory) are anchored for verification.",
    // Dashboard
  ...
  id: {
    ...
    "landing.faq.a2": "Setiap pergerakan stok mendapat bukti terverifikasi bahwa catatan autentik dan belum diubah. Jika ada sengketa, Anda punya jawaban anti-rusak.",
    "landing.faq.q3": "Bisakah seluruh tim bekerja di gudang yang sama bersamaan?",
    "landing.faq.a3": "Ya. Banyak pengguna bisa beroperasi di satu gudang secara bersamaan. Pembaruan stok atomik dan sinkron real-time.",
    "landing.faq.q4": "Peran apa yang tersedia?",
    "landing.faq.a4": "Ada lima peran: Owner, Manager, Staff, Auditor, dan Viewer. Masing-masing mengontrol apa yang bisa dilihat dan dilakukan.",
    "landing.faq.q5": "Jaringan apa yang dipakai untuk verifikasi?",
    "landing.faq.a5": "Chainventory berjalan di Base Sepolia, jaringan uji. Ini membuat gratis dan aman selama produk dimatangkan.",
    "landing.faq.q6": "Apakah data inventaris disimpan di blockchain?",
    "landing.faq.a6": "Tidak. Data operasional hidup di database aman. Hanya catatan bukti (bukan seluruh inventaris) yang ditambatkan untuk verifikasi.",
    // Dashboard
