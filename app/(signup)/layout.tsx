...
/**
 * Signup shell split-screen (referensi Stitch `*_sign_up_split_screen`):
 * panel brand kiri (deep-green + dot pattern + headline + 3 stats) dan
 * panel form kanan di atas kartu putih. Dibatasi ke rute /signup via route
 * group sendiri — login & rute (auth) lain TIDAK tersentuh (tetap shadcn
 * login-03, tidak ada referensi desain login).
 *
 * Logo di kiri digambar inline (varian putih) — komponen <Logo /> milik
 * bersama tidak disentuh (dipakai sidebar di atas background terang).
 */
const BRAND_POINTS = [
        ...
        <div className="relative flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-primary-foreground/80 max-w-md leading-relaxed">
              Real-time stock, role-based access, and a verifiable proof on
              every movement that matters.
            </p>
          </div>
