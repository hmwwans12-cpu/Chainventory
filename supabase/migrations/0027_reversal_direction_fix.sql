-- ============================================================================
-- Chainventory - 0027: reversal mengikuti arah movement ASAL (audit C-02)
-- ============================================================================
-- Bug: cabang reversal SELALU mengurangi stok. Reversal terhadap stock_out
-- seharusnya MENGEMBALIKAN stok (+qty). Arah kini dibaca dari movement_type
-- baris asal (p_reversal_of): asal stock_out -> tambah; selain itu kurangi
-- dengan guard non-negatif. ADDITIVE (create or replace), signature sama.
-- ============================================================================
...
begin
  ...
  -- Warehouse suspended menolak SEMUA mutation (PRD ┬º12 gap closure).
  ...
  -- Balance row lock (SELECT ... FOR UPDATE) ÔÇö hanya untuk tipe yang langsung
  ...
  -- Notifikasi: adjustment butuh approval ÔåÆ OWNER + MANAGER.
  ...
  -- Adjustment ÔåÆ proof dibuat saat approve (movement belum committed).
