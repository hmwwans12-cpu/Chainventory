-- ============================================================================
-- Chainventory — 0032: idempotency scope + guards (audit P1-01, v0.1.3)
-- ============================================================================
-- P1-01: idempotency lookup di-scope ke warehouse_id (sebelumnya global,
--        key sama di warehouse lain menghasilkan IDEMPOTENT palsu).
-- Mencakup semua hardening dari migrasi 0027-0031 (reversal lock,
-- archived product filter, warehouse active guard, qty guard).
...
begin
  ...
  -- Warehouse suspended menolak SEMUA mutation (PRD Ôö£├ÂÔö£├éÔö¼ÔòØ├ö├Â┬╝├ö├▓├ª12 gap closure).
  ...
  -- Balance row lock (SELECT ... FOR UPDATE) ├ö├Â┬úÔö£├é├ö├Â┬úÔö£┬║├ö├Â┬úÔö£├® hanya untuk tipe yang langsung
  ...
  -- Notifikasi: adjustment butuh approval ├ö├Â┬úÔö£├é├ö├Â┬úÔö£├ª├ö├Â┬úÔö£├æ OWNER + MANAGER.
  ...
  -- Adjustment ├ö├Â┬úÔö£├é├ö├Â┬úÔö£├ª├ö├Â┬úÔö£├æ proof dibuat saat approve (movement belum committed).
