...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "bg-muted/60 flex items-center rounded-b-lg border-t p-(--card-spacing)",
        className
      )}
      {...props}
    />
