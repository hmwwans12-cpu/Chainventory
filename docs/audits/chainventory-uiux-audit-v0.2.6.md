...
When the row has errors the button text says "Review errors"; clicking returns to the edit step where errors are no longer visible. User expects to _see_ the errors.
