...
toast.add({
  ...
  description: `${meta.label} · ${movement.quantity} ${movement.unit}`,
});
```
...
**Sprint P2b (a11y + mobile — estimasi 1 jam)** 6. #4 Header account trigger min-h-11 (1 baris) 7. #5 Checkbox hit-area 44px (3 lokasi, 1 kelas) 8. #8 setTimeout cleanup ref (4 baris) 9. #9/#10 Formatter + pageTitle dedup (2 file)

**Sprint P3 (polish — estimasi 45 menit)** 10. #12 Bell text 13→14px (1 baris) 11. #13 themeColor dark variant (1 baris layout) 12. #14 Chart hue lokal (1 baris) 13. #15 Komentar applyFilters (1 baris)
